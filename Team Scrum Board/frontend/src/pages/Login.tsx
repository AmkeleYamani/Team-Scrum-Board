...
function Login() {
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-xl bg-white p-8 shadow-sm">
      ...
      <p className="mt-2 text-sm text-slate-500">Sign in to access your Scrum boards and projects.</p>
      ...
      <p className="mt-6 text-sm text-slate-500">
        New to the board? <Link to="/register" className="font-semibold text-slate-900 underline">Register</Link>
      </p>
    </div>
  );
}
